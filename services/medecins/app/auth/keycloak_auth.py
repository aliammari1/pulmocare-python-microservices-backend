...
class KeycloakAuth:
    ...
    def __init__(self):
        ...
        logger.info(f"Keycloak Auth initialized for medecins service")
    ...
    def doctor_required(self, f):
        """
        Decorator to require doctor role for route access.
...
doctor_required = keycloak_auth.doctor_required
